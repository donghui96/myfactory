...
* @{
*/
#define PRODUCT_KEY "512ebd8bf3714ccdbc045b18ed80774c"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "e9e4ef007c624ee5bc7e1fc9a9afdd2c"
...
* @{
*/
#define ON_OFF_1_BYTEOFFSET                    0
#define ON_OFF_1_BITOFFSET                     0
#define ON_OFF_1_LEN                           1
#define ON_OFF_2_BYTEOFFSET                    0
#define ON_OFF_2_BITOFFSET                     1
#define ON_OFF_2_LEN                           1

#define T_val_RATIO                         1
#define T_val_ADDITION                      -100
#define T_val_MIN                           0
#define T_val_MAX                           200
#define H_val_RATIO                         1
#define H_val_ADDITION                      0
#define H_val_MIN                           0
#define H_val_MAX                           100
/**@} */
...
typedef struct {
  uint8_t flagON_OFF_1:1;
  uint8_t flagON_OFF_2:1;
} attrFlags_t;
