...
public class GosDeviceControlActivity extends GosControlModuleBaseActivity
	...
	private Switch sw_bool_a;
	private Spinner sp_enum_f;
	private TextView tv_data_b;
	private SeekBar sb_data_b;
	private EditText et_extend_c;
	...
	private void initView() {
		...
		sw_bool_a = (Switch) findViewById(R.id.sw_bool_a);
		sp_enum_f = (Spinner) findViewById(R.id.sp_enum_f);
		tv_data_b = (TextView) findViewById(R.id.tv_data_b);
		sb_data_b = (SeekBar) findViewById(R.id.sb_data_b);
		et_extend_c = (EditText) findViewById(R.id.et_extend_c);
	}

	private void initEvent() {

		sw_bool_a.setOnClickListener(this);
		sp_enum_f.setSelection(0, false);
		sp_enum_f.setOnItemSelectedListener(new OnItemSelectedListener() {

			@Override
			public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {

				if (position != data_f) {
					sendCommand(KEY_F, position);
					data_f = position;
				}
			}
		...
		et_extend_c.setOnEditorActionListener(this);
		et_extend_c.addTextChangedListener(new HexWatcher(et_extend_c));
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.sw_bool_a:
			sendCommand(KEY_A, sw_bool_a.isChecked());
			break;
		default:
			break;
		}
	...
	public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
		...
		switch (v.getId()) {
		case R.id.et_extend_c:
			sendCommand(KEY_C, HexStrUtils.hexStringToBytes(v.getText().toString().replaceAll(" ", "")));
			break;
		default:
			break;
		}
	...
	protected void updateUI() {
		...
		sw_bool_a.setChecked(data_a);
		sp_enum_f.setSelection(data_f, true);
		tv_data_b.setText(data_b+"");
		sb_data_b.setProgress((int)((data_b - B_ADDITION) / B_RATIO - B_OFFSET));
		setEditText(et_extend_c, HexStrUtils.bytesToHexString(data_c));
