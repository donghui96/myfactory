...
* @{
*/
#define PRODUCT_KEY "bd6a3d63550a4eafaa0816314d3222cb"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "93259040aae5441cb0167ff6fabe8ddd"
...
#define a_LEN                           1
#define f_BYTEOFFSET                    0
#define f_BITOFFSET                     1
#define f_LEN                           1
#define d_BYTEOFFSET                    22
#define d_BITOFFSET                     0
#define d_LEN                           1
#define e_BYTEOFFSET                    23
#define e_BITOFFSET                     0
#define e_LEN                           1
