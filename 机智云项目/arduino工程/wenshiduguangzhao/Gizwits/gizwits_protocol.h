...
* @{
*/
#define PRODUCT_KEY "cef8b55add6e41a788e36541bd834147"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "727526a85ccb4fc9ae5f4b966c2f5cff"
...
* @{
*/
#define a_BYTEOFFSET                    0
#define a_BITOFFSET                     0
#define a_LEN                           1
#define b_BYTEOFFSET                    0
#define b_BITOFFSET                     1
#define b_LEN                           1

#define wendu_RATIO                         1
#define wendu_ADDITION                      -50
#define wendu_MIN                           0
#define wendu_MAX                           150
#define shidu_RATIO                         1
#define shidu_ADDITION                      -50
#define shidu_MIN                           0
#define shidu_MAX                           150
#define guangzhao_RATIO                         1
#define guangzhao_ADDITION                      -5000
#define guangzhao_MIN                           0
#define guangzhao_MAX                           105000
/**@} */
