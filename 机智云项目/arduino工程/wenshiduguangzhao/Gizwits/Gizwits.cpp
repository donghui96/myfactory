...
void Gizwits::read(EVENT_TYPE_T eventType, bool* value)
{
	...
	{
	      case EVENT_a:
	        *value = currentDataPoint.valuea;
	        break;
	      case EVENT_b:
	        *value = currentDataPoint.valueb;
	        break;
		default:
			break;
	}
...
bool Gizwits::hasBeenSet(EVENT_TYPE_T eventType)
{
	...
	{
			case EVENT_a:
				flag = 	attrFlags.flaga;
				attrFlags.flaga = 0;
				break;
			case EVENT_b:
				flag = 	attrFlags.flagb;
				attrFlags.flagb = 0;
				break;
		default:
			break;
...
void Gizwits::write(VALUE_TYPE_T valueType, uint32_t value)
{
	switch(valueType)
	{
		...
		break;
		case VALUE_guangzhao:
			currentDataPoint.valueguangzhao = value;
		break;
		default:
			break;
	}
