...
void Gizwits::read(EVENT_TYPE_T eventType, uint32_t* value)
{
	...
	{
	      case EVENT_T:
	        *value = currentDataPoint.valueT;
	        break;
	      case EVENT_t:
	        *value = currentDataPoint.valuet;
	        break;
	      case EVENT_H:
	        *value = currentDataPoint.valueH;
	        break;
	      case EVENT_h:
	        *value = currentDataPoint.valueh;
	        break;
...
void Gizwits::write(VALUE_TYPE_T valueType, uint32_t value)
{
	switch(valueType)
	{
		...
		break;
		case VALUE_h1:
			currentDataPoint.valueh1 = value;
		break;
		case VALUE_D:
			currentDataPoint.valueD = value;
		break;
		default:
			break;
	}
