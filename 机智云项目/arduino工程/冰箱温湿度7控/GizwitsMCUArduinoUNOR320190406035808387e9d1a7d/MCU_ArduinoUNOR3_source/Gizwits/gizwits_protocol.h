...
* @{
*/
#define PRODUCT_KEY "e9d1a7dcb260418fb42e3da2a4cce650"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "0d5582773eb245069e63fce3932e38d8"
...
#define up_RATIO                         1
#define up_ADDITION                      -50
#define up_MIN                           0
#define up_MAX                           150
#define down_RATIO                         1
#define down_ADDITION                      -50
#define down_MIN                           0
#define down_MAX                           150
#define time1_RATIO                         1
#define time1_ADDITION                      0
#define time1_MIN                           0
#define time1_MAX                           24
#define time2_RATIO                         1
#define time2_ADDITION                      0
#define time2_MIN                           0
#define time2_MAX                           24
#define S_RATIO                         1
#define S_ADDITION                      0
...
#define s_MAX                           100
#define t1_RATIO                         1
#define t1_ADDITION                      -50
#define t1_MIN                           0
#define t1_MAX                           150
#define t2_RATIO                         1
#define t2_ADDITION                      -50
#define t2_MIN                           0
#define t2_MAX                           150
#define t3_RATIO                         1
#define t3_ADDITION                      -50
#define t3_MIN                           0
#define t3_MAX                           150
#define t4_RATIO                         1
#define t4_ADDITION                      -50
#define t4_MIN                           0
#define t4_MAX                           150
#define t5_RATIO                         1
#define t5_ADDITION                      -50
#define t5_MIN                           0
#define t5_MAX                           150
#define t6_RATIO                         1
#define t6_ADDITION                      -50
#define t6_MIN                           0
#define t6_MAX                           150
#define h6_RATIO                         1
#define h6_ADDITION                      -50
#define h6_MIN                           0
#define h6_MAX                           150
#define t7_RATIO                         1
#define t7_ADDITION                      -50
#define t7_MIN                           0
#define t7_MAX                           150
#define h7_RATIO                         1
#define h7_ADDITION                      -50
#define h7_MIN                           0
#define h7_MAX                           150
#define time_RATIO                         1
