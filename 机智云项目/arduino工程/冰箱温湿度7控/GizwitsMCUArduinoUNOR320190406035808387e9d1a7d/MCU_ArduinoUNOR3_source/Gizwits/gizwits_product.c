...
int8_t gizwitsEventProcess(eventInfo_t *info, uint8_t *data, uint32_t len)
{
  ...
  for(i=0; i<info->num; i++)
  {
    switch(info->event[i])
    {
      ...
      case EVENT_up:
        currentDataPoint.valueup = dataPointPtr->valueup;
        attrFlags.flagup = 1;
        //user handle
        break;
      case EVENT_down:
        currentDataPoint.valuedown = dataPointPtr->valuedown;
        attrFlags.flagdown = 1;
        //user handle
        break;
      case EVENT_time1:
        currentDataPoint.valuetime1 = dataPointPtr->valuetime1;
        attrFlags.flagtime1 = 1;
        //user handle
        break;
      case EVENT_time2:
        currentDataPoint.valuetime2 = dataPointPtr->valuetime2;
        attrFlags.flagtime2 = 1;
        //user handle
        break;
      case EVENT_S:
        currentDataPoint.valueS = dataPointPtr->valueS;
        attrFlags.flagS = 1;
        //user handle
        break;
      case EVENT_s:
